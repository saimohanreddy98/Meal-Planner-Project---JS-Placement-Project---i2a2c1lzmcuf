...
const API_KEY = "776d404cc8eb4f4da83f169ffab9829a";
...
const getMeals = async (bmr) => {
  ...
  const url = `https://api.spoonacular.com//mealplanner/generate?timeFrame=day&targetCalories=${bmr}&apiKey=${'776d404cc8eb4f4da83f169ffab9829a'}&includeNutrition=true`;
...
const generateMealsCard = (datas) => {
  ...
  datas.meals.map(async (data) => {
    const url = `https://api.spoonacular.com/recipes/${data.id}/information?apiKey=${'776d404cc8eb4f4da83f169ffab9829a'}&includeNutrition=false`;
    let imgURL;
    await fetch(url)
      .then((res) => {
        return res.json();
...
const btnRecipe = async (data) => {
  ...
  const url = `https://api.spoonacular.com/recipes/${data}/information?apiKey=${'776d404cc8eb4f4da83f169ffab9829a'}&includeNutrition=false`;
  let information;
  ...
  // equipmentSection
  const urlEquip = `https://api.spoonacular.com/recipes/${data}/equipmentWidget.json?apiKey=${'776d404cc8eb4f4da83f169ffab9829a'}&includeNutrition=false`;
  let equip;
